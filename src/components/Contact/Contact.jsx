  ...
  return (
    <div className='contact'>
      <div className='contact-col'>
        ...
        <ul>
          <li><img src={mail_icon}></img> Contact@GreatStack.dev</li>
          <li><img src={phone_icon}></img> +1 123-456-7890</li>
          <li><img src={location_icon}></img> 77 Massachusetts Ave, Cambridge<br />
      ...
      <div className='contact-col'>
        <form onSubmit={onSubmit}>
          ...
          <textarea type='message' name='name' rows='6' placeholder='Enter your message' required />
